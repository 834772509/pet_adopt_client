<template>
  <div>
    ...
    >
      ...
      <van-empty v-if="dataList.length === 0" description="无送养数据" />
...
import { getPetsList } from "@/services";
...
//       publishList.value.push(...res.data.list);
//       currentPage++;
//       finished.value = false;
//     } else {
//       finished.value = true;
